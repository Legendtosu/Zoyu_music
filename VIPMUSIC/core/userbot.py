    ...
    async def start(self):
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("ZOYU_XD")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("BOY_GIRL_DP")
                await self.four.join_chat("ABOUT_GODFATHER")
                await self.four.join_chat("ZOYU_XD")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("BOY_GIRL_DP")
